...
class ChildBooks extends StatefulWidget {
  const ChildBooks({super.key});

  @override
  State<ChildBooks> createState() => _ChildBooksState();
}

class _ChildBooksState extends State<ChildBooks> {
  @override
        ...
        children: <Widget>[
          ...
          Expanded(
            child: fetchAndDisplayContents(
                'child-books'), // 'your_slug' yerine kendi slug değerinizi girin.
          ),
        ],
      ),
    );
