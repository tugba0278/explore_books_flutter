...
class RomanBooks extends StatefulWidget {
  const RomanBooks({super.key});

  @override
  State<RomanBooks> createState() => _RomanBooksState();
}

class _RomanBooksState extends State<RomanBooks> {
  @override
        ...
        children: <Widget>[
          ...
          Expanded(
            child: fetchAndDisplayContents(
                'roman-books'), // 'your_slug' yerine kendi slug değerinizi girin.
          ),
        ],
      ),
    );
